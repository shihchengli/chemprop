...
dataset=noise20_nitrogen
train_path=../data/groupadditivity_h298/dataset/$dataset/groupadditivity_0.1_$dataset.csv
separate_test_path=../data/groupadditivity_h298/dataset/$dataset/groupadditivity_test_$dataset.csv

# Model training# 1. ensembles
for i in 0 1 2 3 4
do
