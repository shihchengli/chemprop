...
# Model training
# 1. ensembles
results_dir=../models/5_folds/random/$dataset\_co_training/ensembles
...
# 2. dropout
results_dir=../models/5_folds/random/$dataset\_co_training/dropout
python $chemprop_dir/train.py \
--dataset_type regression \
--data_path $train_path \
--save_preds \
...
# 3. mve
results_dir=../models/5_folds/random/$dataset\_co_training/mve
python $chemprop_dir/train.py \
--dataset_type regression \
--data_path $train_path \
--loss_function mve \
...
# 4. evidential
results_dir=../models/5_folds/random/$dataset\_co_training/evidential_0.2
python $chemprop_dir/train.py \
--dataset_type regression \
--data_path $train_path \
...
for alpha in 0.3
do
    results_dir=../models/5_folds/random/$dataset\_co_training/conformal_quantile_regression/alpha_$alpha
    python $chemprop_dir/train.py \
    --dataset_type regression \
    --data_path $train_path \
    --save_preds \
