...
class UncertaintyPredictor:
    def __call__(self, batch: TrainingBatch, models: Iterator[MPNN]):
        return self._calc_prediction_uncertainty(batch, models)

    @abstractmethod
    def _calc_prediction_uncertainty(self, batch, models) -> Tensor:
        """
        Calculate the uncalibrated predictions and uncertainties for the batch of data.
        """
        pass
