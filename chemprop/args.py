...
class TrainArgs(CommonArgs):
    ...
    """
    reaction_mode: Literal['reac_prod', 'reac_diff', 'prod_diff', 'reac_prod_avg', 'reac_prod_balance', 'reac_diff_balance', 'prod_diff_balance', 'reac_prod_avg_balance'] = 'reac_diff'
    """
